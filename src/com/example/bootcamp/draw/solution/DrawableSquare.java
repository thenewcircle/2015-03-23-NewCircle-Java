...
public class DrawableSquare extends DrawableRectangle {
  ...
  public DrawableSquare(int centerX, int centerY, int width, Decorator...decorator) {
    this(centerX, centerY, width, Arrays.asList(decorator));
  }

  public DrawableSquare(int centerX, int centerY, int width, Collection<? extends Decorator> decorators) {
