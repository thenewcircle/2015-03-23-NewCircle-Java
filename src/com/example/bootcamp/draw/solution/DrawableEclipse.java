...
public class DrawableEclipse implements Drawable {
  ...
  public DrawableEclipse(int centerX, int centerY, int width, int height, Decorator...decorator) {
    this(centerX, centerY, width, height, Arrays.asList(decorator));
  }

  public DrawableEclipse(int centerX, int centerY, int width, int height, Collection<? extends Decorator> decorators) {
